...
public class SystemAccountUtils implements ISystemBalance {
    ...
    public boolean depositPlayer(OfflinePlayer payee, double amount) {
        Economy eco = MewEconomy.plugin.getEco();
        ...
        try {
            ...
            MewEconomy.plugin.getLogger().log(Level.SEVERE, "Error depositing player, rolling back: ", e);
            return false;
        }
    }
    ...
    public boolean withdrawPlayer(OfflinePlayer payer, double amount) {
        ...
        try {
            ...
            MewEconomy.plugin.getLogger().log(Level.SEVERE, "Error withdraw player, rolling back: ", e);
            return false;
        }
    }
